...
import { getContactInfo as getContactInfoAPI } from '@api/cms-endpoints';
      ...
      <div className={styles.content}>
        <div className={styles.grid}>
          ...
          >
            ...
            <div className={styles.infoCards}>
              ...
              <div className={styles.infoCard}>
                ...
                <div className={styles.infoContent}>
                  ...
                  <p className={styles.infoText}>
                    {contactInfo ? (lang === 'en' ? contactInfo.addressEn : contactInfo.addressAm) : 'Loading...'}
                  </p>
              ...
              <div className={styles.infoCard}>
                ...
                <div className={styles.infoContent}>
                  ...
                  <p className={styles.infoText}>{contactInfo?.phone || 'Loading...'}</p>
                  {contactInfo?.phone2 && <p className={styles.infoText}>{contactInfo.phone2}</p>}
            ...
            {/* Social Media */}
            {contactInfo && (contactInfo.facebookUrl || contactInfo.twitterUrl || contactInfo.linkedinUrl || contactInfo.telegramUrl || contactInfo.youtubeUrl) && (
              <div className={styles.socialMedia}>
                <h3 className={styles.socialTitle}>{t('contact.followUs') || 'Follow Us'}</h3>
                <div className={styles.socialLinks}>
                  {contactInfo.facebookUrl && (
                    <a href={contactInfo.facebookUrl} target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                  ...
                  {contactInfo.twitterUrl && (
                    <a href={contactInfo.twitterUrl} target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {contactInfo.linkedinUrl && (
                    <a href={contactInfo.linkedinUrl} target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {contactInfo.telegramUrl && (
                    <a href={contactInfo.telegramUrl} target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {contactInfo.youtubeUrl && (
                    <a href={contactInfo.youtubeUrl} target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
